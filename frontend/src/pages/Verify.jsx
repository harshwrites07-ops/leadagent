...
const styles = {
  ...
  iconWrap: { width: 64, height: 64, borderRadius: 16, background: 'rgba(255,69,0,0.08)', border: '1px solid rgba(255,69,0,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' },
  ...
  successBox: { display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,229,160,0.1)', border: '1px solid rgba(0,229,160,0.3)', borderRadius: 8, padding: '10px 12px', fontSize: 13, color: '#00E5A0', marginBottom: 16 },
