  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        {status === 'error' && (
          <>
            <div style={{ ...styles.iconWrap, background: 'rgba(var(--app-danger-rgb),0.08)', border: '1px solid rgba(var(--app-danger-rgb),0.2)' }}>
...
const styles = {
  ...
  card: { width: '100%', maxWidth: 360, background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--r-lg)', padding: '40px 32px', textAlign: 'center' },
  iconWrap: { width: 64, height: 64, borderRadius: 'var(--r-lg)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' },
