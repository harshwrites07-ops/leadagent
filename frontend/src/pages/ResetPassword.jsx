      ...
      <div style={styles.card}>
        ...
        {!done ? (
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={styles.successIcon}><CheckCircle size={28} color="#00E5A0" /></div>
...
const styles = {
  ...
  logoIcon: { width: 36, height: 36, borderRadius: 9, background: 'var(--gradient-orange)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 20px rgba(255,69,0,0.35)', flexShrink: 0 },
  ...
  successIcon: { width: 64, height: 64, borderRadius: 16, background: 'rgba(0,229,160,0.08)', border: '1px solid rgba(0,229,160,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' },
