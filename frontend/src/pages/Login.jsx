...
const styles = {
  ...
  logoText: { fontFamily: 'var(--f-sans)', fontSize: 14, fontWeight: 700, color: '#0a0a0c', letterSpacing: '-0.03em' },
  ...
  btn: { marginTop: 16, padding: '11px', background: 'var(--lime)', border: 'none', borderRadius: 8, color: '#0a0a0c', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--f-sans)' },
